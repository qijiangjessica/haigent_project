          ...
          <div className="relative z-10 grid h-full grid-cols-1 items-center gap-8 p-8 md:grid-cols-2 md:p-12 lg:p-16">
            <div className="flex flex-col items-start text-left text-white">
              ...
              <p className="mt-4 max-w-xl text-lg text-neutral-200">
                Tailored Solutions for Your Organization. Ready-made templates
                provide immediate payback, yet each organization has unique HR
                processes. Haigent.ai develops bespoke AI agent templates that
                align with your recruiting and HR processes.
              </p>
            </div>
